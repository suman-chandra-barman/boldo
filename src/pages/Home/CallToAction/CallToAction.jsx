...
const CallToAction = () => {
  return (
    <section className="max-w-[1200px] bg-[#0A2640] py-[72px] mx-auto text-white md:rounded-xl relative z-[1] overflow-hidden">
      <div className="md:w-[715px] mx-auto">
        ...
        <form className="mt-[50px] md:flex justify-center gap-6 text-center">
          <input
            ...
            className="text-xl px-2 md:px-8 py-2 md:py-3 rounded-[256px] lg:w-[370px] "
          />
