...
const BlogHeader = () => {
  return (
    <section className="max-w-[1200px] mx-auto px-3">
      <div className="text-center text-[#0A2640] mt-5 md:mt-[42px]">
        <h3 className="text-xl ">Blog</h3>
        <h2 className="text-2xl md:text-4xl lg:text-[64px] leading-10 lg:leading-[84px]">
          Thoughts and words
        </h2>
      </div>
      <div className="md:flex gap-5 lg:gap-[100px] mt-5 md:mt-[67px] border-b border-b-[#0A2640npm] pb-10 md:pb-[72px]">
        ...
        <div className="mt-5 md:mt-0 md:w-1/2 flex justify-center items-center">
          <div>
            ...
            <p className="text-2xl lg:text-[48px] leading-8 lg:leading-[72px] mt-3">
